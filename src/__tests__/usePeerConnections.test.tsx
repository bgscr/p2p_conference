...
describe('usePeerConnections', () => {
    ...
    it('should handle an answer', async () => {
        ...
        const pc = result.current.peerConnections.get('peer-3')
    ...
    it('should add ICE candidate when connection exists', async () => {
        ...
        const pc = result.current.peerConnections.get('peer-4')
    ...
    it('should add local stream to all connections', async () => {
        ...
        const pcA = result.current.peerConnections.get('peer-a')
        const pcB = result.current.peerConnections.get('peer-b')
