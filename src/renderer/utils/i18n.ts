...
const en: Translations = {
  ...
  room: {
    ...
    toggleChat: 'Chat (T)',
    pushToTalkHold: 'Push-to-talk enabled: hold your hotkey to speak',
    pushToTalkSpeaking: 'Push-to-talk active: speaking',
  ...
  settings: {
    ...
    pushToTalkDesc: 'Hold a hotkey to speak while muted',
    pushToTalkKey: 'Push-to-talk hotkey',
    ...
    exportDiagnosticsRunning: 'Exporting Diagnostics...',
    exportDiagnosticsSuccess: 'Diagnostics bundle exported successfully',
    exportDiagnosticsFailed: 'Failed to export diagnostics bundle',
    exportDiagnosticsUnavailable: 'Diagnostics export is unavailable in this environment',
  ...
  remoteMic: {
    title: 'Remote Mic Mapping',
    mapMic: 'Map Mic',
    stop: 'Stop Mapping',
    busy: 'Remote mic mapping is already in progress.',
    requestFailed: 'Failed to send remote mic mapping request.',
    responseFailed: 'Failed to send remote mic mapping response.',
    requestReceived: '{name} wants to map their mic to your virtual microphone.',
    requestAccepted: 'Remote mic mapping request accepted.',
    requestRejected: 'Remote mic mapping request was rejected.',
    rejectedBusy: 'Target user is busy with another remote mic session.',
    rejectedVirtualDeviceMissing: 'Target user has no virtual microphone device ready.',
    rejectedInstallFailed: 'Target could not install virtual microphone driver.',
    rejectedRestartRequired: 'Target must restart the system before mapping can start.',
    rejectedUserCancelled: 'Target cancelled virtual microphone driver installation.',
    rejectedByTarget: 'You rejected the remote mic mapping request.',
    waitingForApproval: 'Waiting for {name} to approve remote mic mapping',
    activeAsSource: 'Your microphone is mapped to a remote target.',
    activeAsSourceName: 'Your microphone is mapped to {name}.',
    activeAsTarget: 'Remote source audio is mapped to your virtual microphone.',
    incomingTitle: 'Remote Mic Mapping Request',
    incomingPrompt: '{name} wants to map their microphone to your virtual input.',
    expiresIn: 'Request expires in {seconds}s',
    accept: 'Accept',
    reject: 'Reject',
    installAndAccept: 'Install Virtual Device & Accept',
    installPrompt: 'Virtual output "{device}" is required. Install it now to continue.',
    installStarting: 'Installing {device}. Please approve the administrator prompt.',
    installing: 'Installing virtual audio device...',
    installNoCancel: 'Installation is running. Do not close this window.',
    installTimeout: 'Virtual audio installation timed out.',
    installFailed: 'Virtual audio installation failed.',
    installPrecheckFailed: 'Automatic virtual device installation is unavailable: {reason}',
    installBundleMissing: 'This build cannot auto-install the required virtual device: {reason}',
    installBundleMissingReasonDefault: 'bundled installer assets are missing or invalid.',
    installNeedsRestart: 'Virtual audio installation requires restart. Please reboot and retry.',
    installCancelled: 'Virtual audio installation was cancelled.',
    installCompleted: '{device} installed successfully.',
    installButton: 'Install Virtual Device',
    recheckDevice: 'Re-check device',
    installUnsupportedPlatform: 'Automatic virtual device installation is not available on this platform.',
    requestTimeout: 'Remote mic request timed out.',
    heartbeatTimeout: 'Remote mic session lost heartbeat and was stopped.',
    stopped: 'Remote mic session stopped.',
    peerDisconnected: 'Remote mic session stopped because peer disconnected.',
    virtualDeviceMissing: 'Virtual microphone output device not found.',
    virtualDeviceHint: 'Install and enable virtual output device: {device}',
    openSetup: 'Open Setup Guide',
    setupDocUnavailable: 'Setup guide is unavailable in this build.',
    routingFailed: 'Failed to route microphone audio exclusively to target peer.',
    virtualMicRoute: 'Virtual Mic',
    mapped: 'Mapped',
    expectedDevice: 'Expected virtual output',
    detectedDevice: 'Detected virtual output',
    notDetected: 'Not detected',
    status: 'Mapping readiness',
    ready: 'Ready',
    notReady: 'Not ready',
  },
  moderation: {
    ...
    requestMuteAll: 'Request Mute All',
    raiseHand: 'Raise Hand',
    lowerHand: 'Lower Hand',
    roomLockedBy: 'Room is locked by {name}. New participants cannot join.',
    roomLocked: 'Room locked',
    roomUnlocked: 'Room unlocked',
    roomLockedError: 'This room is currently locked by the host.',
    lockActionFailed: 'Failed to update room lock state',
    muteAllRequestTitle: 'Mute Request',
    muteAllRequestPrompt: '{name} asked everyone to mute.',
    muteAllRequested: 'Mute-all request sent',
    muteAllFailed: 'Failed to send mute-all request',
    muteAllAccepted: 'A participant accepted the mute request',
    muteAllDeclined: 'A participant declined the mute request',
    acceptAndMute: 'Accept and Mute',
    decline: 'Decline',
    handRaiseQueue: 'Hand Raise Queue',
    handRaised: 'Hand raised',
    handLowered: 'Hand lowered',
    handRaiseFailed: 'Failed to update hand raise status',
    youMuted: 'You are now muted',
